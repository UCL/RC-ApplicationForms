...
<head>
<title>Research Computing Platform Services Accounts</title>
<meta charset="UTF-8" />
<link rel="shortcut icon" href="/favicon.ico" />
<link rel="search" type="application/opensearchdescription+xml" href="/mediawiki119/opensearch_desc.php" title="Research Computing Platform Services Wiki (en-gb)" />
<link rel="stylesheet" href="//wiki.rc.ucl.ac.uk/mediawiki119/load.php?debug=false&amp;lang=en-gb&amp;modules=mediawiki.legacy.commonPrint%2Cshared&amp;only=styles&amp;skin=uclrc&amp;*" />
<link rel="stylesheet" href="/mediawiki119/skins/uclrc/main.css?303" media="screen" /><meta name="ResourceLoaderDynamicStyles" content="" />
<link rel="stylesheet" href="//wiki.rc.ucl.ac.uk/mediawiki119/load.php?debug=false&amp;lang=en-gb&amp;modules=site&amp;only=styles&amp;skin=uclrc&amp;*" />
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Main_Page skin-uclrc action-view">
   <head>
      <title>Research Computing Platforms Services</title>
      <link rel="shortcut icon" href="//www.ucl.ac.uk/departments/++resource++images/favicon2.ico" />
         ...
         <!--Start General Layout Styles-->
            ...
            <link href="//www.ucl.ac.uk/departments/++resource++css/ucl_default_2col_layout.css"
            ...
            <link href="//www.ucl.ac.uk/departments/++resource++css/screen/corp-identity-light-blue.css"
                  rel="stylesheet" type="text/css" />
            <!--Corporate identity styling above-->
         <!--End General Layout Styles-->

         <!--Start Print CSS-->
         <link href="//www.ucl.ac.uk/departments/++resource++css/print/print.css"
         ...
         <!--Start JQuery Core User Interface Javascript-->
            <script type="text/javascript"
                    src="//www.ucl.ac.uk/departments/++resource++default_scripts/ui.core.min.js"></script>
         <!--End JQuery Core User Interface Javascript-->

         <!--Start JQuery Font Resizer Javascript-->
            <script type="text/javascript"
                    src="//www.ucl.ac.uk/departments/++resource++default_scripts/fontsizer.jquery.js"></script>
         ...
         <script type="text/javascript"
                 src="//www.ucl.ac.uk/departments/++resource++default_scripts/jquery.doc.ready.js"></script>
         ...
         <link rel="stylesheet" type="text/css"
               href="//www.ucl.ac.uk/departments/local-styles.css" />

         <!-- Stylesheet for high contrast style switching -->
         <link rel="stylesheet" type="text/css"
               id="contrastCSS"
               href="//www.ucl.ac.uk/departments/++resource++css/screen/ucl_normal_view.css" />
         <!--end Silva Style Sheets-->
         
         <!-- styling to actually make links different to h5 elements.  -->
         <style>
    ...
    <body>
          ...
          <!-- Graphic Border - Begin Part 1 -->
             ...
             <div class="page">
                <div id="printLogo">
                   <img src="//www.ucl.ac.uk/departments/++resource++images/printlogo.gif"
                        alt="UCL logo" />
                </div>
        ...
        Research Computing Platform Services Wiki <br /><br /><span style="font-style: italic;"> </span>
                </h1>
                <span class="section_subheader_white"></span>
                <div id="logo_holder"> 
                   <a href="/"><img src="//www.ucl.ac.uk/departments/++resource++images/corp-identity-light-blue.gif"
                                    alt="UCL Home" /></a>
                </div> 
             </div>
             ...
             <div id="nav" class="noprint">
                <div class="hlist" id="corp-identity-light-blue">
                <!--Start Search box-->
                <div id="search">
                   <!--<label for="searchInput">Search</label>-->
                   <form action="/wiki/Special:Search" id="googlesearch">
                            ...
                            <input type='submit' name="fulltext" id="mw-searchButton" class="submit" value="Search" />
                   </form>
                </div>
                <!--End search box-->
                <ul width="50%">
                   ...
                   <li>
                      <a href="">Research Computing Platforms Services</a> 
                      </li>
        </ul>
                <!--<div class="hlist" style="vertical-align:text-top; color: #ff0000;"> -->
                   <ul style="text-align: right;">
                                <li id="pt-anonuserpage"><a href="/wiki/User:128.40.14.83"Array class="new">128.40.14.83</a></li>
                                <li id="pt-anontalk"><a href="/wiki/User_talk:128.40.14.83"Array class="new">Talk for this IP address</a></li>
                                <li id="pt-anonlogin"><a href="/mediawiki119/index.php?title=Special:UserLogin&amp;returnto=Main+Page"Array>Log in</a></li>
                </ul>
                <!-- </div> -->
             </div>
          </div>
                ...
                <div id="col1">
                   <div id="col1_content" class="clearfix">
                      ...
                      <div id="left-silva-content"
                         ...
                         <h3 class="heading">Research Computing Platform Services</h3>
                         <ul class="disc">

                                                  <div class='portlet' id='p-x'>
                            <h5></h5>
                            <div class='pBody'>
                               <ul>
                                                                 <li id="n-mainpage-description"><a href="/wiki/Main_Page"Array>Wiki Main Page</a></li>
               ...
               <div id="col3">
                  ...
                  <?php echo $page_title; ?>            </h2>
                        ...
                        <div class="newsiteminfo">
                           <p><strong class="datepublished-article"></strong></p>
                        </div>

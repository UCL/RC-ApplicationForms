...
<p class="p">
    ...
    The Lancet, or a review paper, please also tick the box alongside so we can highlight these in our
...
<form action="publications.php" method="post" enctype="multipart/form-data">
    <table id="form_table">
        ...
        <tr id="row[0]">
            ...
            <td>
                <input type="text" id="publications[0][link]" placeholder="link"/>
            </td>
        </tr>
        <tr id="add_row_tr">
...
<script language="JavaScript">
    ...
    function add_row() {
        ...
        new_row.innerHTML = ''.concat(
            ...
            "\t\t\t</td>",
            "\t\t\t<td>",
            "\t\t\t\t<input type=\"text\" id=\"publications[", n, "][link]\" placeholder=\"link\"/>",
            "\t\t\t</td>"
        );
    }
</script>
